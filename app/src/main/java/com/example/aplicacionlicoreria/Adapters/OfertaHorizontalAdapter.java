...
import com.example.aplicacionlicoreria.Components.OfertaProduct;
...
public class OfertaHorizontalAdapter extends RecyclerView.Adapter<ViewHolder>{

    private final List<Offers> offersList;

    public OfertaHorizontalAdapter(List<Offers> oList) {
        offersList = oList;
    }
    ...
    public com.example.aplicacionlicoreria.Adapters.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.content_oferta_horizontal, parent, false);
        return new OfertaHorizontalAdapter.ViewHolder(view);
    }
