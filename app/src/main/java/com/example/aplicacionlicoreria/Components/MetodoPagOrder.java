...
public class MetodoPagOrder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_metodo_pag_order);
                    ...
                    if (year <= 27){
                        ...
                        if (cvv >= 010){
                            ...
                            if (filaT.moveToFirst()) {
                                ...
                                //REDIRECCIÓN
                                Intent intentR = new Intent(MetodoPagOrder.this, OrdenarPedido.class);
