...
import com.example.mayikhstyle.Adapters.DetallePedidoAdapter;
...
public class DetallePedidoCompleto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalle_pedido_completo);
    ...
    public void Atras(View view) {
        Intent intent = new Intent(DetallePedidoCompleto.this, PedidosComplete.class);
        startActivity(intent);
    }
    public void PedidoNuevo(View view) {
        Intent intent = getIntent();
        int IdOrder = intent.getIntExtra("idOrders",0);
        Intent intentC = new Intent(DetallePedidoCompleto.this, OrdenarPedido.class);
